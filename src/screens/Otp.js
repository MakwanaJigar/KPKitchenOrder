...
const Otp = ({ navigation, route }) => {
  ...
  const handleVerifyOtp = async () => {
    ...
    if (!email.trim()) {
      Alert.alert(
        'Email Missing',
        'Your email address is missing. Please request a new verification code.',
      );
    ...
    try {
      ...
      Alert.alert('Code Verified', successMessage, [
        {
          text: 'Continue',
          onPress: () => {
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              We sent a {OTP_LENGTH}-digit verification code
              to
            </Text>
            ...
            <Text style={styles.codeHint}>
              Enter the verification code received in your
              email.
            </Text>
...
>
            ...
            <View style={styles.helpCard}>
              ...
              <Text style={styles.helpText}>
                The verification code will expire shortly.
